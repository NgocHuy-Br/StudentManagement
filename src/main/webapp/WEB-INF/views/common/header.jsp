    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <header class="global-header">
            <div class="header-grid">
                ...
                <div class="user-box">
                    <div class="hello">Xin chào, <strong>
                            <c:choose>
                                <c:when test="${firstName != null && !firstName.equals('null')}">${firstName}</c:when>
                                <c:otherwise>User</c:otherwise>
                            </c:choose>
                        </strong></div>
                    <div class="small">Tài khoản
                        <c:choose>
                            <c:when test="${roleDisplay != null && !roleDisplay.equals('null')}">${roleDisplay}</c:when>
