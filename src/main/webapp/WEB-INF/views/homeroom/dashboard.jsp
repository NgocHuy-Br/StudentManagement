                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5 class="mb-0">
                                                                <i class="bi bi-person-circle me-2"></i>Thông tin cá
                                                                nhân
                                                            </h5>
                                                        </div>
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                <div class="col-sm-4"><strong>Mã giáo viên:</strong>
                                                                </div>
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <span class="badge bg-success">Giáo viên chủ
                                                                        nhiệm</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <c:if test="${empty classrooms}">
                                                        <div class="text-center py-4">
                                                            ...
                                                            <p class="text-muted mt-3">Hiện tại bạn chưa được phân công
                                                                chủ
                                                                nhiệm lớp nào.</p>
                                                        </div>
                                                    </c:if>
                                                                    ...
                                                                    <div class="card classroom-card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <a href="${pageContext.request.contextPath}/homeroom/scores?classroomId=${classroom.id}"
                                                                                ...
                                                                                <i
                                                                                    class="bi bi-pencil-square me-1"></i>Nhập
                                                                                điểm
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="p-4">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="alert alert-info">
                                                        <i class="bi bi-info-circle me-2"></i>
                                                        Chức năng lịch giảng dạy sẽ được cập nhật trong phiên bản tiếp
                                                        theo.
                                                    </div>
