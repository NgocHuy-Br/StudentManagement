                                            ...
                                            <div class="col-md-6">
                                                <div class="card">
                                                    <div
                                                        ...
                                                        <h5 class="mb-0"><i class="bi bi-list-ul me-2"></i>Danh sách lớp
                                                            học
                                                        </h5>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select class="form-select form-select-sm"
                                                                    ...
                                                                    <option value="classCode-asc" ${sort=='classCode' &&
                                                                        dir=='asc' || (empty sort && empty dir)
                                                                        ? 'selected' : '' }>Mã lớp (A-Z)</option>
                                                                    <option value="courseYear-asc" ${sort=='courseYear'
                                                                        && dir=='asc' ? 'selected' : '' }>Năm bắt đầu
                                                                        khóa
                                                                        (tăng dần)</option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${selectedClass == null}">
                                                                <div class="text-center text-muted py-5">
                                                                    ...
                                                                    <p class="mt-3">Vui lòng chọn một lớp từ danh sách
                                                                        bên
                                                                        trái
                                                                    </p>
                                                                </div>
                                                            ...
                                                            <c:otherwise>
                                                                ...
                                                                <c:if test="${empty classStudents}">
                                                                    <div class="text-center text-muted py-4">
                                                                        ...
                                                                        <p class="mt-2">Lớp này chưa có sinh viên nào
                                                                        </p>
                                                                    </div>
                                                                </c:if>
                                                            </c:otherwise>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="invalid-feedback" id="addCourseYearError">
                                                    Vui lòng nhập đúng định dạng YYYY-YYYY và năm sau phải lớn hơn năm
                                                    trước
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                        ...
                                                        <c:forEach var="student" items="${availableStudents}">
                                                            <option value="${student.id}">${student.user.username} -
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${not empty student.user.fname and not empty student.user.lname}">
                                                                        ${student.user.lname} ${student.user.fname}
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        ${student.user.username}
                                                                    </c:otherwise>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                <div class="card h-100 border-0 shadow-sm">
                                                    <div class="card-header bg-light">
                                                        <h6 class="mb-0"><i class="bi bi-person-badge me-2"></i>Thông
                                                            tin cơ bản</h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card h-100 border-0 shadow-sm">
                                                    <div class="card-header bg-light">
                                                        <h6 class="mb-0"><i class="bi bi-geo-alt me-2"></i>Thông tin
                                                            liên hệ</h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="mb-3">
